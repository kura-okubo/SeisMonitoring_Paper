...
project_name = "ex_cc_stack_channelcollection_raw_autocorrPSD"
project_inputdir="./"
# project_outputdir="./"
...
set_parameter(fo_mainparam, "stack_RawData_dir",  "/data/wsd04/Parkfield/ex_cc_raw_autocorrPSD_OUTPUT/cc")
