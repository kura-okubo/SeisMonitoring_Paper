#Save at 2021-06-20T23:08:11 by c206-010.frontera.tacc.utexas.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_cc_stack_channelcollection_raw_withoutremovalEQ", String, "project name."),
"project_inputdir"  => (".//ex_cc_stack_channelcollection_raw_withoutremovalEQ_INPUT", String, "project input directory which you initiated with init_project()."),
"project_outputdir"  => ("/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_cc_stack_channelcollection_raw_withoutremovalEQ_OUTPUT", String, "project output directory which you initiated with init_project()."),
"starttime"  => ("2002-01-01T00:00:00", Dates.DateTime, "process start time"),
"endtime"  => ("2020-09-01T00:00:00", Dates.DateTime, "process end time"),
...
"requeststation_file"  => ("/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_cc_stack_channelcollection_raw_withoutremovalEQ_OUTPUT/ex_cc_stack_channelcollection_raw_withoutremovalEQ.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
...
"stack_RawData_dir"  => ("/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_cc_raw_withoutremovalEQ_OUTPUT/cc", String, "\"default\" or absolute/relative path to cc directory. \"default\" links to project OUTPUT/cc."),
