...
from MCMC_func_resheal import * # version including residual healing
...
if __name__ == '__main__':
    ...
    modelparam = {
                ...
                "S1"            : (0.01, [0.0, 0.8]), # scale in coseimic change at SS NOTE: the vmax is assigned as the factor with S1
                ...
                "c0"         : (-0.01, [-np.inf, 0]), # amplitude of residual healing
    ...
    output_datadir = "../processed_data_resheal/MCMC_sampler_{}_v2constraintdvvdrop".format(modelparam["nsteps"])
    ...
    for h5_id in [1, 0]:
        ...
        for modelcase in ["resheal"]:#, "wlin"]:
            ...
            df_tandp= pd.read_csv("../../../Post/ModelFit/data/interped_tempandprecip_longterm.csv", header=0, sep = ',')
            ...
            stationids = [stationpairs.index("BP.EADB-BP.EADB"), stationpairs.index("BP.LCCB-BP.SCYB")]
            # print(stationids)
