#Save at 2021-03-09T20:26:23 by c205-011.frontera.tacc.utexas.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_removeeq_whiten", String, "project name."),
"project_inputdir"  => ("/home1/07208/kokubo09/tmpprojects/SeisMonitoring_Paper/Examples/ex_removeeq_whiten_INPUT", String, "project input directory which you initiated with init_project()."),
...
"requeststation_file"  => ("/home1/07208/kokubo09/tmpprojects/SeisMonitoring_Paper/Examples/ex_removeeq_whiten_INPUT/default_requeststations.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
