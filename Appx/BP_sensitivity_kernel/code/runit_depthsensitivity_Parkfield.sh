...
rm SRDER.PLT
rm SRDER.TXT
sprep96 -M model_Parkfield1D_CVM.dat -DT ${dt} -NPTS 2 -L -R -NMOD 1
sdisp96 -v
# HS and HR are dummy values
slegn96 -HS 0 -HR 0 -DER -NOQ
sregn96 -HS 0 -HR 0 -DER -NOQ
sdpder96 -R -TXT -K 2 -XLEN 3.0 -X0 1.0 -YLEN 4.0
mv SRDER.TXT SRDER_DT${dt}.TXT
sdpder96 -L -TXT -K 2 -XLEN 3.0 -X0 1.0 -YLEN 4.0
mv SLDER.TXT SLDER_DT${dt}.TXT
done
