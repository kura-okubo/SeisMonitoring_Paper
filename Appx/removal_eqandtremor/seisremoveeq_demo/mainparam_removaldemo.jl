...
"project_name"  => ("removaldemo", String, "project name."),
...
"starttime"  => ("2016-01-01T00:00:00", Dates.DateTime, "process start time"),
"endtime"  => ("2016-01-22T00:00:00", Dates.DateTime, "process end time"),
