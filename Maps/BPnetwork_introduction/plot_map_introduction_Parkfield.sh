...
gmt begin map_parkfield eps
	...
	gmt psxy gmt_shelly2017ssefamily.txt -JM${size} -R${range} -Sc0.15 -W1.0,0-0-0 -G${ssecolor}
	...
	# plot SAFOD location
	# gmt psxy SAFOD_location.txt  -JM${size} -R${range} -Sr${safodsize} -W1.0p,${safodcolor}
