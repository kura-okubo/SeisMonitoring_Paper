#Save at 2022-07-02T08:33:54 by cascadia.ess.washington.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_cc_raw_uwbackup", String, "project name."),
"project_inputdir"  => (".//ex_cc_raw_uwbackup_INPUT", String, "project input directory which you initiated with init_project()."),
...
"starttime"  => ("2010-01-01T00:00:00", Dates.DateTime, "process start time"),
...
"requeststation_file"  => ("/data/wsd04/Parkfield/ex_cc_raw_uwbackup_OUTPUT/ex_cc_raw_uwbackup.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
