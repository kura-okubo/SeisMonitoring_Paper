#Save at 2022-03-17T18:14:46 by pnwstore1.ess.washington.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_download_data_uwbackup", String, "project name."),
"project_inputdir"  => (".//ex_download_data_uwbackup_INPUT", String, "project input directory which you initiated with init_project()."),
...
"starttime"  => ("2020-08-01T00:00:00", Dates.DateTime, "process start time"),
...
"requeststation_file"  => ("/data/wd11/Parkfield/ex_download_data_uwbackup_OUTPUT/ex_download_data_uwbackup.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
