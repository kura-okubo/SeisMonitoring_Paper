...
project_name = "ex_cc_raw_withoutremovalEQ"
project_inputdir="./"
#project_outputdir="./"
...
init_project(project_name=project_name,
             ...
             force=false, gui=false # external HDD
            )
...
set_parameter(fo_mainparam, "cc_RawData_path",  "/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_download_data_OUTPUT/seismicdata/rawseismicdata")
