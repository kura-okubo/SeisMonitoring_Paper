#Save at 2021-03-09T20:24:45 by c205-011.frontera.tacc.utexas.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_removeeq_raw", String, "project name."),
"project_inputdir"  => ("/home1/07208/kokubo09/tmpprojects/SeisMonitoring_Paper/Examples/ex_removeeq_raw_INPUT", String, "project input directory which you initiated with init_project()."),
"project_outputdir"  => ("/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_removeeq_raw_OUTPUT", String, "project output directory which you initiated with init_project()."),
...
"requeststation_file"  => ("/home1/07208/kokubo09/tmpprojects/SeisMonitoring_Paper/Examples/ex_removeeq_raw_INPUT/default_requeststations.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
