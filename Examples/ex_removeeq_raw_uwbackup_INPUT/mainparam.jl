#Save at 2022-07-02T00:14:44 by cascadia.ess.washington.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_removeeq_raw_uwbackup", String, "project name."),
"project_inputdir"  => (".//ex_removeeq_raw_uwbackup_INPUT", String, "project input directory which you initiated with init_project()."),
...
"requeststation_file"  => ("/data/wsd04/Parkfield/ex_removeeq_raw_uwbackup_OUTPUT/ex_removeeq_raw_uwbackup.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
...
"RawData_path"  => ("/data/wsd04/Parkfield/ex_download_data_uwbackup_OUTPUT/seismicdata/rawseismicdata", String, "\"default\" or absolute/relative path to rawdata. \"default\" links to project output directory."),
