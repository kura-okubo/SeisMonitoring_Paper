#Save at 2022-08-22T21:02:40 by cascadia.ess.washington.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_cc_stack_channelcollection_raw_autocorrPSD", String, "project name."),
"project_inputdir"  => (".//ex_cc_stack_channelcollection_raw_autocorrPSD_INPUT", String, "project input directory which you initiated with init_project()."),
...
"requeststation_file"  => ("/data/wsd04/Parkfield/ex_cc_stack_channelcollection_raw_autocorrPSD_OUTPUT/ex_cc_stack_channelcollection_raw_autocorrPSD.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
...
"stack_RawData_dir"  => ("/data/wsd04/Parkfield/ex_cc_raw_autocorrPSD_OUTPUT/cc", String, "\"default\" or absolute/relative path to cc directory. \"default\" links to project OUTPUT/cc."),
...
"compute_shorttimestack"  => ("false", Bool, "true if compute shorttime stack for continuous monitoring."),
