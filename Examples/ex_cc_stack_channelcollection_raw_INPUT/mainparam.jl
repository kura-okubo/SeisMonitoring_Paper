#Save at 2021-03-22T06:10:31 by c211-004.frontera.tacc.utexas.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_cc_stack_channelcollection_raw", String, "project name."),
"project_inputdir"  => (".//ex_cc_stack_channelcollection_raw_INPUT", String, "project input directory which you initiated with init_project()."),
"project_outputdir"  => ("/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_cc_stack_channelcollection_raw_OUTPUT", String, "project output directory which you initiated with init_project()."),
...
"requeststation_file"  => ("/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_cc_stack_channelcollection_raw_OUTPUT/ex_cc_stack_channelcollection_raw.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
...
"stack_RawData_dir"  => ("/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_cc_raw_OUTPUT/cc", String, "\"default\" or absolute/relative path to cc directory. \"default\" links to project OUTPUT/cc."),
