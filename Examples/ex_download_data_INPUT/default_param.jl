#Save at 2021-06-20T22:59:49 by c206-010.frontera.tacc.utexas.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_download_data", String, "project name."),
"project_inputdir"  => ("/home1/07208/kokubo09/tmpprojects/SeisMonitoring_Paper/Examples/ex_download_data_INPUT", String, "project input directory which you initiated with init_project()."),
"project_outputdir"  => ("/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_download_data_OUTPUT", String, "project output directory which you initiated with init_project()."),
...
"requeststation_file"  => ("/home1/07208/kokubo09/tmpprojects/SeisMonitoring_Paper/Examples/ex_download_data_INPUT/default_requeststations.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
