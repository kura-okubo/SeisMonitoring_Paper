#Save at 2021-06-20T23:16:14 by c206-010.frontera.tacc.utexas.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_stack_raw_compute_codaQ", String, "project name."),
"project_inputdir"  => ("/home1/07208/kokubo09/tmpprojects/SeisMonitoring_Paper/Examples/ex_stack_raw_compute_codaQ_INPUT", String, "project input directory which you initiated with init_project()."),
"project_outputdir"  => ("/scratch1/07208/kokubo09/SeisMonitoring_Paper/ex_stack_raw_compute_codaQ_OUTPUT", String, "project output directory which you initiated with init_project()."),
...
"requeststation_file"  => ("/home1/07208/kokubo09/tmpprojects/SeisMonitoring_Paper/Examples/ex_stack_raw_compute_codaQ_INPUT/default_requeststations.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
