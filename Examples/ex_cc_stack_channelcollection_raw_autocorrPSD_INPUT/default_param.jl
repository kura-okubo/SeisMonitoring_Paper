#Save at 2022-08-22T21:02:31 by cascadia.ess.washington.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_cc_stack_channelcollection_raw_autocorrPSD", String, "project name."),
"project_inputdir"  => ("/home/kokubo/project/Parkfield_BP/SeisMonitoring_Paper/Examples/ex_cc_stack_channelcollection_raw_autocorrPSD_INPUT", String, "project input directory which you initiated with init_project()."),
"project_outputdir"  => ("/data/wsd04/Parkfield/ex_cc_stack_channelcollection_raw_autocorrPSD_OUTPUT", String, "project output directory which you initiated with init_project()."),
"starttime"  => ("2004-04-01T00:00:00", Dates.DateTime, "process start time"),
"endtime"  => ("2004-04-03T00:00:00", Dates.DateTime, "process end time"),
...
"requeststation_file"  => ("/home/kokubo/project/Parkfield_BP/SeisMonitoring_Paper/Examples/ex_cc_stack_channelcollection_raw_autocorrPSD_INPUT/default_requeststations.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
...
"chanpair_type"  => ("all", Vector{String}, "\"all\" or list of channel pair type. e.g. auto-achan, cross-achan, cross-xchan"),
...
"stack_pairs_option"  => ("11, 22, 33", Vector{String}, "\"all\" or list of component pairs. e.g. XX, YY, ZZ"),
...
"reference_starttime"  => ("2004-04-01T00:00:00", Dates.DateTime, "reference start time"),
"reference_endtime"  => ("2004-04-02T00:00:00", Dates.DateTime, "reference end time"),
