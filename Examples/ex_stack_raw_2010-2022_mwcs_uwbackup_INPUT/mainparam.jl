#Save at 2022-10-30T11:25:08 by cascadia.ess.washington.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_stack_raw_2010-2022_mwcs_uwbackup", String, "project name."),
"project_inputdir"  => (".//ex_stack_raw_2010-2022_mwcs_uwbackup_INPUT", String, "project input directory which you initiated with init_project()."),
"project_outputdir"  => ("/data/wsd04/Parkfield/ex_stack_raw_2010-2022_mwcs_uwbackup_OUTPUT", String, "project output directory which you initiated with init_project()."),
...
"requeststation_file"  => ("/data/wsd04/Parkfield/ex_stack_raw_2010-2022_mwcs_uwbackup_OUTPUT/ex_stack_raw_2010-2022_mwcs_uwbackup.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
...
"pairs_option"  => ("all", Vector{String}, "\"all\" or list of component pairs. e.g. XX, YY, ZZ"),
...
"stack_RawData_dir"  => ("/data/wsd04/Parkfield/ex_cc_raw_uwbackup_OUTPUT/cc", String, "\"default\" or absolute/relative path to cc directory. \"default\" links to project OUTPUT/cc."),
...
"compute_reference"  => ("false", Bool, "true if compute reference stack for longterm stack."),
...
"reference_endtime"  => ("2022-06-01T00:00:00", Dates.DateTime, "reference end time"),
...
"mwcs_window_step"  => ("2.0", Float64, "[s] The step to jump for the moving window."),
