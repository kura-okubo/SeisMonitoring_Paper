...
$HOME/packages/julia-1.5.3/bin/julia -p $np run_smstats.jl /home1/07208/kokubo09/scratch/SeisMonitoring_Paper/ex_stack_raw_compute_codaQ_OUTPUT/stack/shorttime ../OUTPUT dvvdqq monitoring_stats_raw_compute_codaQ.csv
