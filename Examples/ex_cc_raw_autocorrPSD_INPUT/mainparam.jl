#Save at 2022-08-22T04:35:48 by cascadia.ess.washington.edu
using Dates, DataStructures
InputDict = OrderedDict(
"project_name"  => ("ex_cc_raw_autocorrPSD", String, "project name."),
"project_inputdir"  => (".//ex_cc_raw_autocorrPSD_INPUT", String, "project input directory which you initiated with init_project()."),
"project_outputdir"  => ("/data/wsd04/Parkfield/ex_cc_raw_autocorrPSD_OUTPUT", String, "project output directory which you initiated with init_project()."),
...
"freqency_band"  => ("0.001, 10.0", Float64, "Frequency bands to be analyzed."),
...
"requeststation_file"  => ("/data/wsd04/Parkfield/ex_cc_raw_autocorrPSD_OUTPUT/ex_cc_raw_autocorrPSD.jld2", String, "Request station dataframe saved in JLD2. See default_requeststations.jld2"),
...
"maxlag"  => ("120", Float64, "[s] Maximum time lag of cross-correlation."),
"cc_RawData_path"  => ("/data/wsd04/Parkfield/ex_removeeq_raw_uwbackup_OUTPUT/seismicdata/seisremoveeq", String, "\"default\" or absolute/relative path to rawdata. \"default\" links to project OUTPUT/EQRemovedData.jld2."),
...
"pairs_option"  => ("11, 22, 33", Vector{String}, "\"all\" or list of component pairs. e.g. XX, YY, ZZ"),
"chanpair_type"  => ("auto-achan", Vector{String}, "\"all\" or list of channel pair type. e.g. auto-achan, cross-achan, cross-xchan"),
...
"cc_bpfilt_method"  => ("Raw", String, "Frequency decomposition method. \"Butterworth\" or \"Wavelet\"."),
"cc_taper_α0"  => ("0.05", Float64, "Advanced: Lowest tapering fraction for frequency adaptive tapering."),
...
"stack_pairs_option"  => ("all", Vector{String}, "\"all\" or list of component pairs. e.g. XX, YY, ZZ"),
